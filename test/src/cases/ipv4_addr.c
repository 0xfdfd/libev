...
TEST_FIXTURE_SETUP(misc)
{
    ...
    ASSERT_EQ_D32(ev_loop_init(&g_test_09d8.s_loop), 0);
    ASSERT_EQ_D32(ev_tcp_init(&g_test_09d8.s_loop, &g_test_09d8.s_socket), 0);
}
...
TEST_F(misc, ipv4_addr)
{
    ...
    ASSERT_EQ_D32(ev_tcp_bind(&g_test_09d8.s_socket, (struct sockaddr*)&addr, sizeof(addr)), 0);

    memset(&addr, 0, sizeof(addr));
    ASSERT_EQ_D32(ev_tcp_getsockname(&g_test_09d8.s_socket, (struct sockaddr*)&addr, &len), 0);

    ASSERT_EQ_D32(ev_ipv4_name(&addr, NULL, g_test_09d8.s_buffer, sizeof(g_test_09d8.s_buffer)), 0);
