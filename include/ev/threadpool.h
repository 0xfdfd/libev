...
typedef void (*ev_threadpool_close_cb)(ev_threadpool_t* pool);
...
struct ev_threadpool
{
    ...
    ev_cycle_list_node_t            cpu_queue;
    ev_cycle_list_node_t            io_fast_queue;
    ev_cycle_list_node_t            io_slow_queue;
};
