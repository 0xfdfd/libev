...
/**
 * @brief Initialize #ev_async_plt_t to an Unix specific invalid value.
 */
...
/**
 * @brief Initialize #ev_loop_plt_t to Unix specific invalid value.
 */
...
/**
 * @brief Initialize #ev_tcp_backend_t to Unix specific invalid value.
 */
...
/**
 * @brief Initialize #ev_pipe_backend_t to Unix specific invalid value.
 */
...
/**
 * @brief Initialize #ev_shm_backend_t to Unix specific invalid value.
 */
